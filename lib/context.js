 ...
 */
export function buildContextualPrompt(responseStyle, customPrompts) {
 ...
 */
export function getResponseTemplate(responseStyle, customPrompts) {
 ...
 */
export function getDomainAdvice(domain) {
 ...
 */
export function buildAIPrompt(userMessage, responseStyle, customPrompts) {
 ...
 */
export function applyContextToResponse(aiResponse, responseStyle, customPrompts) {
